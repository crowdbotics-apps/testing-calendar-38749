...
## Project Structure
    ...
    ├── testing_calendar_38749  # Django project configurations
...
1. Clone this repo and `cd testing_calendar_38749`
...
2. Clone this repo and `cd testing_calendar_38749`
